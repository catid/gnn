...
CONDITIONS = {
    ...
    "retrieved": {
        "display": "RetrievedReadout",
        "model": {
            "enable_cache": True,
            "cache_output_summary_readout": True,
            "cache_output_summary_source": "retrieved",
        },
    },
}
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v69 retrieval-weighted output readout rescue",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "schedules": SCHEDULES,
        "promotion_rule": "Positive only if retrieved readout improves C2 dense_mean in the main seeds and does not lose the fresh rerun.",
    }
