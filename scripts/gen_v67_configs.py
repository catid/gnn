...
CONDITIONS = {
    ...
    "fusion": {
        "display": "CacheSummaryFusion",
        "model": {
            "enable_cache": True,
            "cache_home_summary_fusion": True,
        },
    },
}
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v67 cache summary fusion rescue",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "schedules": SCHEDULES,
        "promotion_rule": "Positive only if fusion improves C2 dense_mean in the main seeds and does not lose the fresh rerun.",
    }
...
def main() -> None:
    ...
    for regime in COLLISION_REGIMES:
        for condition in CONDITIONS:
            for schedule in SCHEDULES:
                payload = build_collision_config(regime, schedule, condition=condition)
    ...
    (REPORTS / "v67_pack_definitions.json").write_text(
