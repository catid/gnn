...
CONDITIONS = {
    ...
    "sharpblend": {
        "display": "CollisionSharpenedBlendReadout",
        "model": {
            "enable_cache": True,
            "cache_output_summary_readout": True,
            "cache_output_summary_source": "collision_sharpened_blend",
            "cache_output_gate_feature_scale": 1.0,
            "cache_output_collision_switch_width": 2.0,
            "cache_output_collision_blend_scale": 1.0,
        },
    },
}
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v88 collision-sharpened summary blend",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "promotion_rule": "Positive only if sharpblend improves C2 dense mean and does not lose the fresh rerun.",
    }
    ...
    for regime in COLLISION_REGIMES:
        for condition in CONDITIONS:
            for schedule in SCHEDULES:
                ...
                write_train_script(script_path, cfg_path.relative_to(ROOT))

    (REPORTS / "v88_pack_definitions.json").write_text(
