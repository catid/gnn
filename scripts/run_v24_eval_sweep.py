...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run eval sweeps for v24 task-grad micro-neighborhood runs.")
    ...
    parser.add_argument("--selectors", nargs="+", choices=SELECTORS, default=None)
