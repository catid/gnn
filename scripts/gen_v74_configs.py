...
CONDITIONS = {
    ...
    "maxaug": {
        "display": "MaxAugmentedReadout",
        "model": {
            "enable_cache": True,
            "cache_output_summary_readout": True,
            "cache_output_summary_source": "max_augmented",
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v74 max-augmented output readout",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "schedules": SCHEDULES,
        "promotion_rule": "Positive only if the max-augmented readout improves C2 dense_mean in the main seeds and does not lose the fresh rerun.",
    }
...
def main() -> None:
    ...
    (REPORTS / "v74_pack_definitions.json").write_text(
