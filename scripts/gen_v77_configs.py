...
CONDITIONS = {
    ...
    "ambigmaxgate": {
        "display": "AmbiguityAwareMaxGateReadout",
        "model": {
            "enable_cache": True,
            "cache_output_summary_readout": True,
            "cache_output_summary_source": "ambiguity_max_gate",
            "cache_output_gate_feature_scale": 1.0,
            "cache_output_max_scale": 1.0,
            "cache_output_aux_feature_scale": 1.0,
        },
    },
}
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v77 ambiguity-conditioned max gate",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "schedules": SCHEDULES,
        "promotion_rule": "Positive only if the ambiguity-conditioned max gate improves C2 dense_mean in the main seeds and does not lose the fresh rerun.",
    }
...
def main() -> None:
    ...
    (REPORTS / "v77_pack_definitions.json").write_text(
