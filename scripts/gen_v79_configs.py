...
CONDITIONS = {
    ...
    "ambigbase": {
        "display": "AmbiguityBaseSuppressedReadout",
        "model": {
            "enable_cache": True,
            "cache_output_summary_readout": True,
            "cache_output_summary_source": "ambiguity_base_suppression",
            "cache_output_gate_feature_scale": 1.0,
            "cache_output_base_suppression_scale": 1.0,
        },
    },
}
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v79 ambiguity-conditioned base suppression",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "schedules": SCHEDULES,
        "promotion_rule": "Positive only if ambiguity-conditioned base suppression improves C2 dense_mean in the main seeds and does not lose the fresh rerun.",
    }
...
def main() -> None:
    ...
    (REPORTS / "v79_pack_definitions.json").write_text(
