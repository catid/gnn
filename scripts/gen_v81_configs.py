...
CONDITIONS = {
    ...
    "ambigent": {
        "display": "AmbiguityEntropyAwareReadout",
        "model": {
            "enable_cache": True,
            "cache_output_summary_readout": True,
            "cache_output_summary_source": "ambiguity_entropy_gate",
            "cache_output_gate_feature_scale": 1.0,
        },
    },
}
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v81 entropy-aware output gate",
        },
...
def main() -> None:
    ...
    (REPORTS / "v81_pack_definitions.json").write_text(
