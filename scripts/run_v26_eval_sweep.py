...
def main() -> None:
    ...
    parser.add_argument("--lr-multipliers", nargs="*", type=float, default=[])
    ...
    for regime in args.regimes:
        for schedule in args.schedules:
            for selector in args.selectors:
                prefixes: list[str]
                if regime == "core" and schedule == "p" and args.lr_multipliers:
                    prefixes = [
                        f"v26-core-{selector}-32-p-lr{int(round(multiplier * 100)):03d}"
