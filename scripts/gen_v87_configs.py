...
CONDITIONS = {
    ...
    "retrhead": {
        "display": "CollisionRetrievedHeadReadout",
        "model": {
            "enable_cache": True,
            "cache_output_summary_readout": True,
            "cache_output_summary_source": "collision_retrieved_head",
            "cache_output_gate_feature_scale": 1.0,
            "cache_output_collision_switch_width": 2.0,
            "cache_output_collision_retrieved_scale": 1.0,
        },
    },
}
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v87 collision-gated retrieved correction",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "schedules": SCHEDULES,
        "promotion_rule": "Positive only if the collision-gated retrieved correction improves C2 dense_mean in the main seeds and does not lose the fresh rerun.",
    }
...
def main() -> None:
    ...
    (REPORTS / "v87_pack_definitions.json").write_text(
