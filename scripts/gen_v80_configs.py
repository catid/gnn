...
CONDITIONS = {
    ...
    "ambigclass": {
        "display": "AmbiguityClassSliceSuppressedReadout",
        "model": {
            "enable_cache": True,
            "cache_output_summary_readout": True,
            "cache_output_summary_source": "ambiguity_classslice_suppression",
            "cache_output_gate_feature_scale": 1.0,
            "cache_output_classslice_suppression_scale": 1.0,
        },
    },
}
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v80 ambiguity-conditioned class-slice suppression",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "schedules": SCHEDULES,
        "promotion_rule": "Positive only if ambiguity-conditioned class-slice suppression improves C2 dense_mean in the main seeds and does not lose the fresh rerun.",
    }
...
def main() -> None:
    ...
    (REPORTS / "v80_pack_definitions.json").write_text(
