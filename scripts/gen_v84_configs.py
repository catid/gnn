...
CONDITIONS = {
    ...
    "splitfloor": {
        "display": "CollisionSplitFloorReadout",
        "model": {
            "enable_cache": True,
            "cache_output_summary_readout": True,
            "cache_output_summary_source": "collision_split_floor_gate",
            "cache_output_gate_feature_scale": 1.0,
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v84 collision-split floor gate",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "schedules": SCHEDULES,
        "promotion_rule": "Positive only if the collision-split floor gate improves C2 dense_mean in the main seeds and does not lose the fresh rerun.",
    }
...
def main() -> None:
    ...
    (REPORTS / "v84_pack_definitions.json").write_text(
