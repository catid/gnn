...
CONDITIONS = {
    ...
    "confblend": {
        "display": "ConfidenceBlendReadout",
        "model": {
            "enable_cache": True,
            "cache_output_summary_readout": True,
            "cache_output_summary_source": "confidence_blend",
            "cache_output_retrieved_blend_threshold": 0.5,
        },
    },
}
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v71 confidence-gated output blend",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "schedules": SCHEDULES,
        "promotion_rule": "Positive only if confidence-blend improves C2 dense_mean in the main seeds and does not lose the fresh rerun.",
    }
