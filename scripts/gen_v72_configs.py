...
CONDITIONS = {
    ...
    "qcond": {
        "display": "QueryConditionedReadout",
        "model": {
            "enable_cache": True,
            "cache_output_summary_readout": True,
            "cache_output_summary_source": "query_conditioned",
            "cache_output_query_condition_scale": 1.0,
        },
    },
}
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v72 query-conditioned output readout",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "schedules": SCHEDULES,
        "promotion_rule": "Positive only if query-conditioned readout improves C2 dense_mean in the main seeds and does not lose the fresh rerun.",
    }
