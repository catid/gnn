...
CONDITIONS = {
    ...
    "intfloor": {
        "display": "CollisionInteractionFloorReadout",
        "model": {
            "enable_cache": True,
            "cache_output_summary_readout": True,
            "cache_output_summary_source": "collision_interaction_floor_gate",
            "cache_output_gate_feature_scale": 1.0,
            "cache_output_gate_floor_scale": 1.0,
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v85 collision-interaction floor gate",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "schedules": SCHEDULES,
        "promotion_rule": "Positive only if the collision-interaction floor gate improves C2 dense_mean in the main seeds and does not lose the fresh rerun.",
    }
...
def main() -> None:
    ...
    (REPORTS / "v85_pack_definitions.json").write_text(
