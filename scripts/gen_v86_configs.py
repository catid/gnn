...
CONDITIONS = {
    ...
    "splithead": {
        "display": "CollisionSpecializedHeadReadout",
        "model": {
            "enable_cache": True,
            "cache_output_summary_readout": True,
            "cache_output_summary_source": "collision_specialized_head",
            "cache_output_gate_feature_scale": 1.0,
            "cache_output_collision_switch_width": 2.0,
            "cache_output_collision_head_scale": 1.0,
        },
    },
}
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v86 collision-specialized output head",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "schedules": SCHEDULES,
        "promotion_rule": "Positive only if the collision-specialized output head improves C2 dense_mean in the main seeds and does not lose the fresh rerun.",
    }
...
def main() -> None:
    ...
    (REPORTS / "v86_pack_definitions.json").write_text(
