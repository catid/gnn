...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v75 ambiguity-aware output gate",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "schedules": SCHEDULES,
        "promotion_rule": "Positive only if the ambiguity-aware gate improves C2 dense_mean in the main seeds and does not lose the fresh rerun.",
    }
...
def main() -> None:
    ...
    (REPORTS / "v75_pack_definitions.json").write_text(
