...
CONDITIONS = {
    ...
    "ambigfilm": {
        "display": "AmbiguityFeatureModulatedReadout",
        "model": {
            "enable_cache": True,
            "cache_output_summary_readout": True,
            "cache_output_summary_source": "ambiguity_feature_modulation",
            "cache_output_gate_feature_scale": 1.0,
            "cache_output_feature_modulation_scale": 1.0,
        },
    },
}
...
def base_config() -> dict:
    return {
        ...
        "runtime": {
            ...
            "report_root": "reports",
            "run_name": "",
            "notes": "v78 ambiguity-feature output modulation",
        },
...
def pack_definitions() -> dict:
    return {
        ...
        "schedules": SCHEDULES,
        "promotion_rule": "Positive only if ambiguity-feature modulation improves C2 dense_mean in the main seeds and does not lose the fresh rerun.",
    }
...
def main() -> None:
    ...
    (REPORTS / "v78_pack_definitions.json").write_text(
