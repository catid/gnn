...
SUMMARY_PATH = REPORTS / "summary_metrics_v35.json"
REPORT_PATH = REPORTS / "final_report_v35_sparse_cag_package_confirmation.md"

SELECTORS = {
    "visit_taskgrad_half": {"label": "VT-0.5"},
    "visit_taskgrad_half_agree_mutate_z00_m075_f050": {"label": "VT-0.5 CAG-z0.0-m0.75-f0.50"},
}
...
def main() -> None:
    ...
    for phase, summary in phase_summaries.items():
        plot_phase(summary, phase, REPORTS / f"v35_{phase}_summary.png")
    ...
    lines.extend(
        [
            ...
            "## Outputs",
            "",
            f"- Summary JSON: [summary_metrics_v35.json]({SUMMARY_PATH})",
            f"- Report: [final_report_v35_sparse_cag_package_confirmation.md]({REPORT_PATH})",
