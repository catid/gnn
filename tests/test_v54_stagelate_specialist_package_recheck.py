...
def test_v54_generator_emits_stage_late_and_package():
    module = load_module("gen_v54_configs", "scripts/gen_v54_configs.py")
...
def test_v54_eval_completion_filter(tmp_path):
    module = load_module("run_v54_eval_sweep", "scripts/run_v54_eval_sweep.py")
...
def test_v54_report_builder_tracks_four_specialist_regimes():
    module = load_module("build_v54_report", "scripts/build_v54_report.py")
