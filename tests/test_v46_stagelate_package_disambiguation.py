...
def test_v46_generator_emits_three_arms():
    module = load_module("gen_v46_configs", "scripts/gen_v46_configs.py")
...
def test_v46_eval_completion_filter(tmp_path):
    module = load_module("run_v46_eval_sweep", "scripts/run_v46_eval_sweep.py")
...
def test_v46_report_builder_has_transfer_phases():
    module = load_module("build_v46_report", "scripts/build_v46_report.py")
    assert set(module.PHASES) == {"t1_xl", "t1r_xl", "t2a_xl"}
    assert "stageadaptive_late_half" in module.SELECTORS
