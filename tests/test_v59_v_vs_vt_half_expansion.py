...
def test_v57_generator_emits_all_rule_regimes():
    module = load_module("gen_v59_configs", "scripts/gen_v59_configs.py")
...
def test_v57_eval_completion_filter(tmp_path):
    module = load_module("run_v59_eval_sweep", "scripts/run_v59_eval_sweep.py")
...
def test_v57_report_builder_tracks_rules_and_scopes():
    module = load_module("build_v59_report", "scripts/build_v59_report.py")
